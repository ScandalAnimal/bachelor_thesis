...
# /home/norman/CLionProjects/bachelor_thesis/STUDY/cudd-3.0.0/cudd-3.0.0/nanotrav/.libs/lt-nanotrav -p 1 -trav -image depend -depend ./nanotrav/s27c.blif
# CUDD Version 3.0.0
...
Used buckets in unique table: 1.56% (expected 1.60%)
...
Maximum resident size            =  5156K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1040
Swaps = 0
Input blocks = 8
Output blocks = 8
