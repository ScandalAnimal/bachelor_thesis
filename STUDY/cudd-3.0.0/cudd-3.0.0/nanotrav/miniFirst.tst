...
# /home/norman/CLionProjects/bachelor_thesis/STUDY/cudd-3.0.0/cudd-3.0.0/nanotrav/.libs/lt-nanotrav -p 1 -second ./nanotrav/miniSecond.blif ./nanotrav/miniFirst.blif
# CUDD Version 3.0.0
...
Used buckets in unique table: 3.05% (expected 3.21%)
...
Maximum resident size            =  4984K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1027
Swaps = 0
Input blocks = 16
Output blocks = 8
