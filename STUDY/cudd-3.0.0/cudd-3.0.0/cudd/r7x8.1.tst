...
Number of cache collisions: 789
Number of cache deletions: 1209
Cache used slots = 59.23% (expected 62.38%)
...
Maximum resident size            =  4484K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1011
Swaps = 0
Input blocks = 8
Output blocks = 16
