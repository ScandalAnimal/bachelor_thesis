...
{ node [shape = box]; "0xae6";
}
}
"  v0  " -> "0xaec" [style = solid];
"  v1  " -> "0xaf0" [style = solid];
"  v2  " -> "0xb2e" [style = solid];
"  v3  " -> "0xb31" [style = solid];
"0xb2e" -> "0xb2d";
"0xb2e" -> "0xb1e" [style = dashed];
"0xaf0" -> "0xaed";
"0xaf0" -> "0xae6" [style = dashed];
"0xb31" -> "0xb30";
"0xb31" -> "0xae6" [style = dashed];
"0xaec" -> "0xae6";
"0xaec" -> "0xae6" [style = dotted];
"0xb30" -> "0xb2f";
"0xb30" -> "0xb1f" [style = dashed];
"0xaed" -> "0xae6";
"0xaed" -> "0xae6" [style = dotted];
"0xb2d" -> "0xb1e";
"0xb2d" -> "0xae6" [style = dashed];
"0xb2f" -> "0xb1f";
"0xb2f" -> "0xae6" [style = dashed];
"0xb1e" -> "0xae6";
"0xb1e" -> "0xae6" [style = dotted];
"0xb1f" -> "0xae6";
"0xb1f" -> "0xae6" [style = dotted];
"0xae6" [label = "1"];
}
Entering testBdd3
...
"  s0  " -> "0xb63" [style = solid];
"  s1  " -> "0xb65" [style = solid];
"  s2  " -> "0xb67" [style = solid];
"  c3  " -> "0xb68" [style = solid];
"0xb67" -> "0xb66";
"0xb67" -> "0xb66" [style = dotted];
"0xb68" -> "0xaed";
"0xb68" -> "0xb66" [style = dashed];
"0xaed" -> "0xae6";
"0xaed" -> "0xae6" [style = dotted];
"0xb65" -> "0xb64";
"0xb65" -> "0xb64" [style = dotted];
"0xb66" -> "0xb1f";
"0xb66" -> "0xb64" [style = dashed];
"0xb1f" -> "0xae6";
"0xb1f" -> "0xae6" [style = dotted];
"0xb64" -> "0xb3e";
"0xb64" -> "0xb62" [style = dashed];
"0xb63" -> "0xb62";
"0xb63" -> "0xb62" [style = dotted];
"0xb3e" -> "0xae6";
"0xb3e" -> "0xae6" [style = dotted];
"0xb62" -> "0xae6";
"0xb62" -> "0xae6" [style = dotted];
"0xae6" [label = "1"];
}
...
{ rank = same; "CONST NODES";
{ node [shape = box]; "0xae7";
"0xae6";
}
}
"  s0  " -> "0xaf4" [style = solid];
"  s1  " -> "0xb09" [style = solid];
"  s2  " -> "0xb20" [style = solid];
"  c3  " -> "0xb29" [style = solid];
"0xb20" -> "0xb17";
"0xb20" -> "0xb1c" [style = dashed];
"0xb29" -> "0xb23";
"0xb29" -> "0xb27" [style = dashed];
"0xb1c" -> "0xb10";
"0xb1c" -> "0xae7" [style = dashed];
"0xb27" -> "0xb17";
"0xb27" -> "0xae7" [style = dashed];
"0xb23" -> "0xae6";
"0xb23" -> "0xae7" [style = dashed];
"0xb09" -> "0xb02";
"0xb09" -> "0xb07" [style = dashed];
"0xb17" -> "0xb11";
"0xb17" -> "0xb15" [style = dashed];
"0xb10" -> "0xb0c";
"0xb10" -> "0xb07" [style = dashed];
"0xb07" -> "0xafb";
"0xb07" -> "0xae7" [style = dashed];
"0xb15" -> "0xb02";
"0xb15" -> "0xae7" [style = dashed];
"0xb11" -> "0xae6";
"0xb11" -> "0xae7" [style = dashed];
"0xb0c" -> "0xae6";
"0xb0c" -> "0xae7" [style = dashed];
"0xb02" -> "0xafc";
"0xb02" -> "0xb00" [style = dashed];
"0xaf4" -> "0xaeb";
"0xaf4" -> "0xaf2" [style = dashed];
"0xafb" -> "0xaf7";
"0xafb" -> "0xaf2" [style = dashed];
"0xb00" -> "0xaeb";
"0xb00" -> "0xae7" [style = dashed];
"0xaf2" -> "0xaea";
"0xaf2" -> "0xae7" [style = dashed];
"0xafc" -> "0xae6";
"0xafc" -> "0xae7" [style = dashed];
"0xaf7" -> "0xae6";
"0xaf7" -> "0xae7" [style = dashed];
"0xaeb" -> "0xae6";
"0xaeb" -> "0xae7" [style = dashed];
"0xaea" -> "0xae6";
"0xaea" -> "0xae7" [style = dashed];
"0xae7" [label = "0"];
"0xae6" [label = "1"];
}
Entering testBdd4
...
"  lb  " -> "0xb5b" [style = dotted];
"  ub  " -> "0xb1f" [style = solid];
"  f  " -> "0xb5a" [style = solid];
"  primes  " -> "0xb56" [style = solid];
"  lprime  " -> "0xb56" [style = solid];
"0xb5a" -> "0xb57";
"0xb5a" -> "0xb59" [style = dashed];
"0xb57" -> "0xb1f";
"0xb57" -> "0xb54" [style = dotted];
"0xb5b" -> "0xb54";
"0xb5b" -> "0xae6" [style = dashed];
"0xb56" -> "0xb1f";
"0xb56" -> "0xae6" [style = dotted];
"0xb59" -> "0xb0e";
"0xb59" -> "0xae6" [style = dotted];
"0xb0e" -> "0xb1f";
"0xb0e" -> "0xae6" [style = dashed];
"0xb54" -> "0xae6";
"0xb54" -> "0xb1f" [style = dotted];
"0xb1f" -> "0xae6";
"0xb1f" -> "0xae6" [style = dotted];
"0xae6" [label = "1"];
}
...
Used buckets in unique table: 4.27% (expected 4.19%)
