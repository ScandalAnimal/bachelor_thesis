...
# /home/norman/CLionProjects/bachelor_thesis/STUDY/cudd-3.0.0/cudd-3.0.0/nanotrav/.libs/lt-nanotrav -p 1 -ordering dfs -reordering win4 -verify ./nanotrav/s27.blif ./nanotrav/s27b.blif
# CUDD Version 3.0.0
...
Maximum resident size            =  5104K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1029
Swaps = 0
Input blocks = 8
Output blocks = 8
