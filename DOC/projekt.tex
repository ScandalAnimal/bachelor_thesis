...
\projectinfo{
  ...
  title.cs={Knižnica pre boolovské funkcie v algebraickej normálnej forme},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
