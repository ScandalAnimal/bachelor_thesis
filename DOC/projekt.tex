...
\projectinfo{
  ...
  title.cs={Knižnica pre booleovské funkcie 
  	v algebra\-ickej normálnej forme},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
...
\declaration{Prehlasujem, že som túto bakalársku prácu vypracoval samostatne pod vedením pána Ing. Rolanda Dobaia, Ph.D.
...
\acknowledgment{Týmto by som sa chcel poďakovať pánovi Ing. Rolandovi Dobaiovi, Ph.D. za rady, trpezlivosť,	vecné pripomienky a pomoc pri vypracovaní tejto práce.}
