...
%\documentclass[slovak,zadani,print]{fitthesis} % pro tisk - odkazy jsou černé
...
\usepackage{listings}
\renewcommand{\lstlistingname}{Zdrojový kód}% Listing -> Zdrojový kód
\usepackage[czech,noline,ruled,longend,linesnumbered]{algorithm2e}
\usepackage[width=12cm]{caption}
...
<<<<<<< HEAD
  title.cs={Knihovna pro Boolovské funkce v algebraické normální formě},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
=======
  title.cs={Knižnica pre Boolove funkcie v~Algebraickej Normálnej Forme},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
>>>>>>> 4047b29d657e89d2457e50f634fba7d8f50cd86f
  title.en={Library for Boolean Functions in Algebraic Normal Form}, %nazev prace v anglictine / thesis title in english
  %Autor / Author
  author={Maroš Vasilišin},   %cele jmeno a prijmeni autora / full name and surname of the author
  author.name={Maroš},   %jmeno autora (pro citaci) / author name (for reference) 
  author.surname={Vasilišin},   %prijmeni autora (pro citaci) / author surname (for reference) 
  ...
  %Skolitel / supervisor
  supervisor=Roland Dobai, %cele jmeno a prijmeni skolitele / full name and surname of the supervisor
  supervisor.name={Roland},   %jmeno skolitele (pro citaci) / supervisor name (for reference) 
  supervisor.surname={Dobai},   %prijmeni skolitele (pro citaci) / supervisor surname (for reference) 
